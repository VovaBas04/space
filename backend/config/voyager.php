...
return [
    ...
    */
    ...
    'database' => [
        'tables' => [
            'hidden' => ['migrations', 'roles','user_roles','translations','users','failed_jobs','telescope_monitoring','telescope_entries_tags','telescope_entries','permissions','menus','data_rows', 'data_types', 'menu_items', 'password_resets', 'permission_role', 'personal_access_tokens', 'settings'],
        ],
